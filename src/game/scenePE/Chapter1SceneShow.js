...
class Chapter1SceneShow extends Phaser.Scene {
	...
	editorCreate() {
		...
		// bg
		const bg = this.add.image(458.6434531253542, 252, "bg");
...
// export default class Chapter1SceneShow extends Phaser.Scene {
//     constructor() {
//         super("Chapter1SceneShow");
//     }
