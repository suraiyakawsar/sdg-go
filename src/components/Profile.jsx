...
// //     try {
// //         // If stored as array:  [1,2,3], if stored as number: just parseInt
...
// //     // Adjust this formula as you wish! 
...
// //         // ✅ Read name from localStorage if available
// //         const savedName = localStorage.getItem("playerName") || profile?.name || "Raya";
...
// //     // ✅ Get last route for continue button
...
// //             // Optional: trigger storage event for other tabs
...
// //                             {/* Content */}
// //                             <div className="p-6 lg:p-8 grid lg: grid-cols-[360px_1fr] gap-6">
// //                                 {/* LEFT: Identity + actions */}
// //                                 <m.div
// //                                     initial={{ opacity: 0, x: -10 }}
// //                                     animate={{ opacity: 1, x: 0 }}
...
//             // Use updateProfile from PlayerContext (not setProfile)
//             updateProfile({
//                 ...profile,
//                 name: newName,
//             });
