...
export default function OnboardingPage() {
    ...
    const [step, setStep] = useState(1); // 1 = name/role, 2 = avatar
    ...
    function handleNameSubmit(e) {
        ...
        setError("");
        setStep(2); // Go to avatar picker
    }

    function handleAvatarSelect(avatarConfig) {
        const profile = {
            name: name.trim(),
            role,
            avatar: avatarConfig, // ← Save avatar config
            sdgPoints: 0,
            badges: [],
            currentChapter: 1,
        };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-800 text-white">
            <div className="w-full max-w-md rounded-3xl bg-gray-900/80 border border-purple-500/40 p-6 shadow-2xl">
                    ...
                    <>
                        ...
                        <form onSubmit={handleNameSubmit} className="space-y-4">
                            ...
                            <p className="text-xs text-gray-400">
                                Your progress is stored locally in this browser only.
                            </p>

                            <button
                                type="submit"
                                className="w-full py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold hover:from-green-600 hover:to-emerald-700 transition"
                            >
                                Next:  Choose Avatar →
                            </button>
                        </form>
                ...
                {step === 2 && (
                    <>
                        <h1 className="text-2xl font-bold mb-1 text-center">Choose Your Avatar</h1>
                        <p className="text-sm text-gray-300 mb-2 text-center">
                            Pick a style and variation, {name}!
                        </p>
