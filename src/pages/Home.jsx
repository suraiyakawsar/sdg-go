...
//   const lastRoute = localStorage.getItem("sdgExplorer:lastRoute") || "/game";
...
//       localStorage.removeItem("sdgPoints"); // if you have this
//       localStorage.removeItem("profile"); // if you store profile locally
...
//             {/* ACTIONS - 4 cards (2x2 on mobile, 1x4 on desktop) */}
...
//                 Icon={FiRotateCcw}
//                 title="Start Over"
//                 desc="Erase all progress and begin fresh."
//                 rightMeta="Reset"
...
//                 className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm placeholder: text-white/40 outline-none focus:border-purple-300/40 focus:ring-2 focus:ring-purple-500/20"
//               />
//             </div>
...
//                     <div className="text-xs text-white font-medium">SDG</div>
...
export default function Home() {
  ...
  return (
          ...
          <m.div {...pageEnter} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
              <ActionCard
                ...
                tone="emerald"
                Icon={FiPlay}
                title={lastRoute !== "/game" ? "Continue" : "Start Game"}
                desc={lastRoute !== "/game" ? "Resume from where you left off." : "Jump into the story and earn SDG points. "}
                rightMeta="Story Mode"
          ...
          >
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                onChange={(e) => setQuery(e.target.value)}
                placeholder="Search goals (e.g.  4, climate, water)…"
                className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none focus:border-purple-300/40 focus:ring-2 focus:ring-purple-500/20"
              />
            </div>
    ...
    `,
                  ...
                  <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 transition bg-[radial-gradient(70%_70%_at_50%_0%,rgba(168,85,247,0.16),transparent_65%)]" />
                </m.button>
              ))}
            </div>
          </m.div>
